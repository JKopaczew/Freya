...
private:
    ...
    VkSemaphore renderFinishedSemaphores; //TODO: research semaphores
...
#
	...
	void createCommandBuffers() {
		...
		for (rsize_t i = 0; i < commandBuffers.size(); i++) {
	...
	void drawFrame() {
		...
		auto err = vkQueueSubmit(graphicsQueue, 1, &submitInfo, VK_NULL_HANDLE);
		if (err != VK_SUCCESS) {
